...
# 库存转移
# 指定包含CSV文件的目录
csv_directory = '/Users/flash/OneDrive/闪电快车/LCP/0331-4-移库'
...
# 写入到XLSX文件
combined_df.to_excel('/Users/flash/OneDrive/闪电快车/LCP/0331-4-移库/tmp_th_combined_move_data0322.xlsx', index=False)
