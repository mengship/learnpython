...
# 库存转移
# 指定包含CSV文件的目录
csv_directory = '/Users/flash/OneDrive/闪电快车/LCP/0327包材/02'
...
# 写入到XLSX文件
combined_df.to_excel('/Users/flash/OneDrive/闪电快车/LCP/0327包材/02/tmp_th_combined_packagingMaterial_data02.xlsx', index=False)
