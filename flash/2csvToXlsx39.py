...
for file_path in file_paths:
    # 读取文件内容
    with open(file_path, 'r', encoding='utf-8') as file: # encoding='gbk' utf-8
        content = file.read()
...
combined_df.to_excel(os.path.join(out_directory, 'tmp_th_NotCompletedShelves.xlsx'), index=False)
